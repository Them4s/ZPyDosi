...
if not No_MAYA:
    ...
    # paf_xs = f"/YourFolder/data/xsdata/sss/jeff33_crocus_bmc_{socket.gethostname()}/ace"
    # paf_bp = f"/YourFolder/data/xsdata/sss/jeff33_crocus_bmc_{socket.gethostname()}"+"/"+bd
    paf_bp = "/YourFolder/data/xsdata/sss/"+bd
else:
...
Skip_BMC=False # To skip the BMC (mostly for Debug)
only_plot_fast=False
### General FCT ###
