...
plt.show()
# plt.figure()Scripts/ModelsnSim/oldW$^{-1}$")
# # plt.yscale("log")
# # plt.xscale("log")
# plt.grid()
# plt.show()
...
Lambda=5.06413e-5
def func2(w):
    Lambda*w + betha[0]*w/(lambda_[0]+w) + betha[1]*w/(lambda_[1]+w)+ betha[2]*w/(lambda_[2]+w)+ betha[3]*w/(lambda_[3]+w)+ betha[4]*w/(lambda_[4]+w)+ betha[5]*w/(lambda_[5]+w)+ betha[6]*w/(lambda_[6]+w)+ betha[7]*w/(lambda_[7]+w)+ betha[8]*w/(lambda_[8]+w)+ betha[9]*w/(lambda_[9]+w)+ betha[10]*w/(lambda_[10]+w)+ betha[11]*w/(lambda_[11]+w)
